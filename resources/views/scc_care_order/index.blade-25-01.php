                ...
                <table class="form_content">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="input_container"><input type="text" id="birthdate" name="birthdate" class="datepicker form-control" value="{{$object->birthdate}}"  /></td>
                            <td class="field_container">Date of Death</td>
                            <td class="input_container"><input type="text" id="deathdate" name="deathdate" class="datepicker form-control" value="{{$object->deathdate}}" /></td>
                        </tr>
                        <tr>
                ...
                <table class="table table-striped table-bordered table-hover" id="products_table" style="width:100%">
                    ...
                    <tbody>
					 ...
					 <?php foreach($item_categories as $key => $category):?>
					   <tr id="r1">
                            <td>
                                <label for="<?php echo $category["group_name"]?>"><?php echo $category["group_name"]?></label>
                            ...
                            <td class="qty" id="base_td_qty_r1"><input type="text" onkeyup="this.value=this.value.replace(/[^0-9\-]/g,'');"  class="form-control qty_order" id="qty_order_r1" name="qty_order_r1[]" value="" /></td>
                            <?php if ($extra_q_td > 0):?>
                                <?php for($i = 1;$i < $extra_q_td; $i++):?>
                                        <td class="qty"><input type="text" onkeyup="this.value=this.value.replace(/[^0-9\-]/g,'');"  class="form-control qty_order" id="qty_order_r1" name="qty_order_r1[]" value="" /></td>
                                <?php endfor;?>
                            <?php endif;?>
                            <td class="add_column_td">&nbsp;</td>
                            <?php if (!in_array($object->care_type, array("chanting","tentage"))):?>
                            ...
                            <td><input type="text" class="form-control" id="unit_price_r1" name="unit_price[]" value="" /></td>
