...
<div class="section section-two">  
            ...
            <div>
                <table style="width:100%; border-spacing: 3px">
                    <tr>
                        <td>Date & time</td><td><?php echo date('d/m/Y, h:m',time()); ?></td><td style='text-align:right'>Official receipt- Customer copy</td>
                   </tr>
                   <tr>
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td colspan="8" style="height:40px;border:0">For cheque settlement, this receipt issued is subjected to clearance of cheque. </td>
                    </tr>
                    <tr>
                        <td colspan="8" style="border:0;height:20px;"></td>
                    </tr>
                    <tr>
                        <td colspan="8" style="text-align:right;border:0">
                            <?php 
                                if(isset($signature)){
                                $sign = json_decode($signature,true);
                            ?>
                            <img  src="<?php  echo $sign[1];?>" style="width:100px; border: 1px solid;height:51px"/>
                                <?php } ?>
                        </td>
                    </tr>
                    <tr>
