            ...
            <div id="funeral_day">
                ...
                <table class="form_content">
                    <tbody>
                        ...
                        <tr><td class="field_container" colspan="6"><a href="https://eservices.nea.gov.sg/atad/JSP/ilsc/security/start.jsp" target="_blank">[Click here for NEA website]</a></td></tr>
            ...
            <div id="removal">
                ...
                <table class="form_content">
                    <tbody>
                        ...
                        <tr><td class="field_container"><i class='btn btn-success'>Sent to</i></td><td class="input_container"><input type="text" id="sent_to1" name="sent_to1" value="{{$object->sent_to1}}" class="form-control" /></td><td colspan="4" class="input_container"><input type="text" id="sent_to2" name="sent_to2" value="{{$object->sent_to2}}" class="form-control" /></td></tr>
                        <tr><td class="field_container" colspan="6">&nbsp;</td></tr>
                        <tr><td class="field_container">Change parlour</td><td class="input_container"><input type="text" class="form-control"  /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text"  class="form-control" /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text" class="form-control"  /></td></tr>
                        <tr><td class="field_container">Transfer parlour</td><td class="input_container"><input type="text" class="form-control"  /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text"  class="form-control" /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text" class="form-control"  /></td></tr>
                        <tr><td class="field_container">Add parlour</td><td class="input_container"><input type="text" class="form-control"  /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text"  class="form-control" /></td><td class="field_container">From date & Time</td><td class="input_container"><input type="text" class="form-control"  /></td></tr>
                        <tr><td class="field_container" colspan="6">&nbsp;</td></tr>
                        <tr><td class="field_container" colspan="6"><a href="">Click to generate Parlour form</a></td></tr>
                        <tr><td class="field_container" colspan="6">&nbsp;</td></tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="6" style="text-align: right; padding-top: 30px">
                                <input type='button' value="NEXT" id="next_bttn" />
                            </td>
                        </tr>
                    </tbody>
                </table>
