        ...
        <!--<div class="section_title"> selection</div>-->
            <div>
              ...
              -->
                ...
                <div id="ala_carte_item_{{$item['id']}}" onclick="selectImagesInsteadItem2select(this)" class="item2select 
                        @if (isset($order))
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td class="item_text">
                                    <span class="parlour_name_container">{{(isset($item['selection_item_name']))?$item['selection_item_name']:''}}</span>
