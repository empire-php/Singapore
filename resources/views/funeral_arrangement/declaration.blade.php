<form action="{{ URL::to('/save_step1') }}"  id="signature_frm" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    ...
    <div id="fa_form" class="needs_exit_warning">
        ...
        <div style="text-align:center">
            ...
            <table style="width:88%; margin-left:6%; margin-top: 40px">
                ...
                <tr>
                    <td id="f2_remarks_container" colspan="5" style="text-align: left;">
                    ...
                    <td style="text-align: center; width: 392px;">
                        ...
                        <div class="signature_box" id="signature_box_1">
                              ...
                              <div id="signature1" data-name="signature1" data-max-size="2048" 
                                   ...
                                   <input type="hidden" id="signature_image_1" name="signature_image_1" />
                    ...
                    <td style="text-align: center; width: 392px;">
                        ...
                        <div class="signature_box" id="signature_box_2">
                              ...
                              <div id="signature2" data-name="signature2" data-max-size="2048" 
                                   data-pen-tickness="3" data-pen-color="black" 
                                   class="sign-field"></div>
                                   <input type="hidden" name="signature_image_2" id="signature_image_2" />
                                   <button class="btn btn-primary" >Ok</button>
                ...
                <tr>
                    ...
                    <td>
                        Date: <span id="date_signature_1"></span><input type="hidden" name="date_signature_1" id="input_date_signature_1" />
                    </td>
                    <td>
                        &nbsp; 
                    </td>
                    <td>
                        Date: <span id="date_signature_2"></span><input type="hidden" name="date_signature_2" id="input_date_signature_2" />
                    </td>
                    <td>
                        &nbsp; 
                    </td>
