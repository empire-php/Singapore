...
class ParlourOrders extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'parlour_orders';
    ...
    {
        return $this->belongsToMany('App\User', 'parlour_order_manpower', 'user_id', 'parlour_order_id');
    }
    
    public function membersCleaning()
    {
        return $this->belongsToMany('App\User', 'parlour_order_cleaning', 'user_id', 'parlour_order_id');
    }
    ...
    public static function getBookedTime( $parlourId, $booked_from_day, $booked_to_day, $orderId = null  ){
