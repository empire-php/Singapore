...
<?php  foreach($data as $key => $ordersales): 
 ...
 //     isset($format[1]) ? $cents =(int)$format[1] : $cents =0 ;
...
<div class="section section-two">  
            ...
            <div class="page-header" style="width:30%;height:70px;text-align: center;">
                <h3>Tax Invoice</h3>
            </div><br>
            ...
            <div>
                  <table style="width:100%; border-spacing: 3px">
                   ...
                   <tr>
                        <td>  POC name</td><td></td><td style='text-align:right'>Invoice No.&nbsp;&nbsp;&nbsp; <b><?php echo $invoice_num; ?></b></td>
                   </tr>
                   <tr>
                       <td></td><td></td><td style='text-align:right'>Date &nbsp;&nbsp;&nbsp; <?php echo date('d/m/Y',time());?></td>
                   </tr>
                   <tr>
                       <td></td><td></td><td style='text-align:right'>Payment term &nbsp;&nbsp;&nbsp;   immediate</td>
                   </tr>
            ...
            <div>Comments</div>
            <div style="border: 0.5px solid #e0e7e8;height:50px"></div><br>
            <h5>Terms : Appreciate immediate payment as late payment interest will be improsed for any outstanding balance at the rate of 2% per month.</h5><br>
            <h5>Singapore Dollars:<br>
            <?php $dollar = explode(".", ($total+$totalGts-$paid)); echo convertTowords($dollar[0]); ?>&nbsp;Dollars&nbsp;
                          
                    <?php isset($dollar[1]) ? $cents =(int)$dollar[1] : $cents =0 ; ?>
                    <?php if($cents != 0){ ?>
                      and
