$(document).ready(function(){
    ...
    $(".hearse_form").find("#booked_to_day").on("change", function (e) {
        ...
        if ($(this).val() != ""){
            $.getJSON( "/hearse/booked_hours",{booked_from_day: $(".hearse_form").find("#booked_from_day").val(), booked_to_day: $(".hearse_form").find("#booked_to_day").val(), hearse_id: $(".hearse_form").find("#hearse_id").val(), order_id: $(".hearse_form").find("#order_id").val()}, function( data ) {
                ...
                if ($(".hearse_form").find("#booked_from_day").val() != $(".hearse_form").find("#booked_to_day").val() && lastVal != ""){
    ...
    $(".hearse_form").find("#booked_from_time, #booked_to_time").change(function(){
        if ($(".hearse_form").find("#booked_from_time").val() && $(".hearse_form").find("#booked_to_time").val() && $(".hearse_form").find("#booked_from_day").val() && $(".hearse_form").find("#booked_to_day").val() && $(".hearse_form").find("#unit_price").val()){
            
            var arrDayFrom = $(".hearse_form").find("#booked_from_day").val().split("/");
            var arrTimeFrom = $(".hearse_form").find("#booked_from_time").val().split(":");
            var arrDayTo = $(".hearse_form").find("#booked_to_day").val().split("/");
    ...
    var table = $('#oldhearsallclisting_tbl').on( 'order.dt',  function () { 
        $('#oldhearsallclisting_tbl').find("tr").each(function(){
            var nrTD = 0;
    ...
    /* Dashboard Hearses Allocation Filter form listing */
    $('#hearsesallocationfilter_bttn').click(function(){
        //alert($(this).parents("form").serialize());
        table.ajax.url( '/hearse/hearseallclisting?'+$(this).parents("form").serialize() ).load();
    });
