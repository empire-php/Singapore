...
<form action="/columbarium/save"  id="info_frm" method="post" enctype="multipart/form-data" class="master_form needs_exit_warning">
    ...
    <!--For point 9-->
    <input type="hidden"  name="group_items" id="group_items" value=""  />
    <input type="hidden"  id="group_items_checked" value="1"  />
    ...
    <div class="section_content">
        <table class="form_content" style="width:80%">
            <tbody>
                <tr>
                        <td class="field_container">Title</td>
                            <td class="input_container">
                                <select name="deceased_title" id="deceased_title" style="width:200px;" class="form-control">
									<option value=""></option>
                                    <option value="Mr"   
				...
				<tr><td class="field_container">Deceased Name</td><td colspan="5" class="input_container">
                <input type="text" name="deceased_name"  id="deceased_name" class="form-control" value="{{$order->deceased_name}}" style="width:200px;"  /></tr>
    ...
    <div class="section_content ">
        <table class="bordered_table" id="order_items_tbl" style="width:96%">
            ...
            <tr class="active_rows">
                <td><a href="#" id="get_columbarium_items" onclick="">Columbarium Charges: (Click to view slab selection)</a></td>
                <td>
                    <input type="text"  class="form-control" name="disabled_selection" disabled="" value="{{ (isset($item_selection["selection"][0]))?$item_selection["selection"][0]:"" }}" />
                    <input type="hidden"  class="form-control"  name="selection[]"  value="{{ (isset($item_selection["selection"][0]))?$item_selection["selection"][0]:"" }}" />
                </td>
                <td><input type="text" class="form-control" name="comments[]" value="{{ (isset($item_selection["comments"][0]))?$item_selection["comments"][0]:"" }}"  /></td>
                <td><span class="amount_view"></span>
                    <input type="text" class="form-control"  name="disabled_amount" disabled="" value="{{ (isset($item_selection["amount"][0]))?$item_selection["amount"][0]:"" }}"  />
                    <input type="hidden" class="form-control"  name="amount[]" value="{{ (isset($item_selection["amount"][0]))?$item_selection["amount"][0]:"" }}"  />
                </td>
            </tr>
            <tr class="active_rows">
...
<!---   For point 6 -->
    <div class="modal fade" id="add_columbarium" tabindex="-1" role="dialog" style="overflow:scroll">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 700px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="gem_stones_title">View Columbarium</h4>
            </div>
    ...
    <div class="modal fade" id="view_all_images_for_columbarium" tabindex="-1" role="dialog" style="z-index:22222">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 700px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
